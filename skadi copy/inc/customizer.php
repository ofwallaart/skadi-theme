 ...
 * @return void
 */
function skadi_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function skadi_customize_partial_blogdescription() {
 ...
 */
function skadi_customize_preview_js() {
	wp_enqueue_script( 'skadi-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
add_action( 'customize_preview_init', 'skadi_customize_preview_js' );
